        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', gridColumn: 'span 2' }}>
            ...
            <div style={{ display: 'flex', gap: '0.85rem', marginTop: '0.5rem' }}>
              {/* LinkedIn */}
              <a href="#" style={{ color: '#94a3b8', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#ff5a00'} onMouseLeave={(e) => e.currentTarget.style.color = '#94a3b8'}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
              ...
              <li><a href="#services" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.8rem', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = 'var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color = '#94a3b8'}>UI/UX Design</a></li>
              <li><a href="#services" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.8rem', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = 'var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color = '#94a3b8'}>Cloud & DevOps</a></li>
              <li><a href="#services" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.8rem', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = 'var(--accent-primary)'} onMouseLeave={(e) => e.target.style.color = '#94a3b8'}>QA & Testing</a></li>
            </ul>
          </div>
      ...
      <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.05)', padding: '0.75rem 0' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1.25rem', fontSize: '0.78rem' }}>
            <a href="#" style={{ color: '#64748b', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = '#ff5a00'} onMouseLeave={(e) => e.target.style.color = '#64748b'}>Privacy Policy</a>
            <span style={{ color: 'rgba(255, 255, 255, 0.05)' }}>|</span>
            <a href="#" style={{ color: '#64748b', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = '#ff5a00'} onMouseLeave={(e) => e.target.style.color = '#64748b'}>Terms & Conditions</a>
          </div>
        </div>
      </div>
